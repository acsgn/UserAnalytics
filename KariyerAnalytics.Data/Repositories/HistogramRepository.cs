...
namespace KariyerAnalytics.Data.Repositories
{
    ...
    {
        public HistogramResponse[] GetResponseTimesHistogram(TimeSpan interval, DateTime after, DateTime before)
        {
        ...
        public HistogramResponse[] GetResponseTimesHistogramByEndpoint(string endpoint, TimeSpan interval, DateTime after, DateTime before)
        {
            using (var repository = new GenericRepository<Log>())
            {
                var responseTimeRequest = new SearchDescriptor<Log>()
